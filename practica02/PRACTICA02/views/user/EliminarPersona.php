...
<h1>Eliminar un contacto de persona de la agenda.</h1>
    ...
    <form action="#" method="get">
        <fieldset>
            <legend>Persona a eliminar</legend>
    ...
    <?php
        ...
        if(isset($_GET["envio"])){
            UserController::show($_GET["nombre"], $_GET["apellidos"]);
            echo "<br><a href='/user/eliminar?nombre=" . $_GET["nombre"] . "&apellidos=" . $_GET["apellidos"]. "'>¿Desea eliminar el contacto de la agenda?</a>";            
        }   
    ?>
    <!-- Pie de página -->

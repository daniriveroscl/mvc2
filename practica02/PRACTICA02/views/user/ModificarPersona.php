...
<body>
 ...
 <header>
    ...
    <h1>Modificar datos contacto de persona.</h1>
    ...
    <h4>Datos de la persona a modificar:</h4>
        ...
        <input type="text" id="apellidosModificar" name="apellidosModificar" required><br><br>
    ...
    <?php
        ...
        if(isset($_GET["envio"])){
            UserController::show($_GET["nombreModificar"], $_GET["apellidosModificar"]);
        }   
    ?>

    <form action="modificar" method="post">        
        <input type="text" id="nombreModificar" value="<?= $_GET["nombreModificar"]?>" name="nombreModificar" hidden>
        <input type="text" id="apellidosModificar" value="<?= $_GET["apellidosModificar"]?>" name="apellidosModificar" hidden>
        ...
        <fieldset>
            ...
            <input type="apellidos" id="apellidos" name="apellidos" ><br><br>           

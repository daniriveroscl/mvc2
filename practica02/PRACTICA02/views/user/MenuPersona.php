...
<body>
 ...
 <header>
    ...
    <h1>Gestión de contactos de personas.</h1>
    <ul>
        <li>
            <ul>
                <li><a href="/user/personaNueva">Nuevo Contacto</a></li>
                <li><a href="/user/eliminarPersona">Eliminar contacto</a></li>
                <li><a href="/user/modificarPersona">Modificar contacto</a></li>
                <li><a href="/user/buscarPersona">Buscar contacto</a></li>
                <li><a href="/user/showAll">Mostrar todos los contactos</a></li>
            </ul>
        </li>        
    </ul>
    <!-- Pie de página -->

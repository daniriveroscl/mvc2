...
<body>
    ...
    <!-- Formulario que redirecciona a la función insertar de EnterpriseController mediante el método post.-->
    <!-- Se añaden los datos para crear el nuevo contacto de empresa -->
    <form action="insertar" method="post">
        <fieldset>
            <legend>Datos empresa nueva:</legend>

...
<!--Menú de selección de opciones a realizar para la gestión de contactos de empresas. Cada link manda a una función diferente de EnterpriseController -->    
<h1>Menú de operaciones de contactos de empresas.</h1>
    <ul>
        <li>
            <ul>
            <li><a href="/enterprise/empresaNueva">Nueva empresa</a></li>
                <li><a href="/enterprise/eliminarEmpresa">Eliminar empresa</a></li>
                <li><a href="/enterprise/modificarEmpresa">Modificar empresa</a></li>
                <li><a href="/enterprise/buscarEmpresa">Buscar empresa</a></li>
                <li><a href="/enterprise/showAll">Mostrar todas las empresas</a></li>
            </ul>
        </li>        
    </ul>
            <!-- Pie de página -->
